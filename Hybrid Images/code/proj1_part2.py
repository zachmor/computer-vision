...
#save_image('../results/low_frequencies1.jpg', np.clip(low_frequencies, 0, 1))
#save_image('../results/high_frequencies1.jpg', np.clip(high_frequencies+0.5, 0, 1))
save_image('../results/hybrid_image5.jpg', np.clip(hybrid_image, 0, 1))
save_image('../results/hybrid_image_scales5.jpg', np.clip(vis, 0, 1))
...
for i in range(1, 8):
	...
	#save_image('../results/low_frequencies1.jpg', np.clip(low_frequencies, 0, 1))
	#save_image('../results/high_frequencies1.jpg', np.clip(high_frequencies+0.5, 0, 1))
	save_image('../results/hybrid_image'+str(i)+'.jpg', np.clip(hybrid_image, 0, 1))
	save_image('../results/hybrid_image_scales'+str(i)+'.jpg', np.clip(vis, 0, 1))
